...
;(function ($, window, document) {
    ...
    radialIndicator.defaults = {
        radius: 19, //inner radius of indicator
        barWidth: 5, //bar width
        barBgColor: 'rgba(0,0,0,0)', //unfilled bar color
        barColor: '#349ad8', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
        format: null, //format indicator numbers, can be a # formator ex (##,###.##) or a function
        frameTime: 10, //miliseconds to move from one frame to another
        frameNum: null, //Defines numbers of frame in indicator, defaults to 100 when showing percentage and 500 for other values
        fontColor: 'rgba(0,0,0,0.6)', //font color
